...
************************************************************************/
  ...
  #define OLCD_SCL  PTD1_OUT  //D1
  #define OLCD_SDA  PTD2_OUT   //D2
  #define OLCD_RST  PTC15_OUT  //C15
  #define OLCD_DC   PTD3_OUT   //D3
  #define OLCD_CS   PTD5_OUT   //D5
...
void LCD_Init(void)        
{
        ...
        gpio_init (PTD5, GPO,HIGH);
        gpio_init (PTC15, GPO,LOW);
         
	OLCD_SCL=1;
	//LCD_CS=1;	//预制SLK和SS为高电平   	
	OLCD_CS = 0 ; ///使能信号端，拉低时正常使用
	OLCD_RST=0;
	LCD_DLY_ms(50);
	OLCD_RST=1;
